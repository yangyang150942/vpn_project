...
public class ForwardClient
{
  ...
  /*      sessionPort = clientHandshake.sessionPort;
     ...
     */
    static public void startForwardClient() throws IOException, InvalidKeyException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchPaddingException {
        ...
        ForwardServerClientThread forwardThread =
            new ForwardServerClientThread(clientSocket,
                                          clientHandshake.sessionHost, clientHandshake.sessionPort,
                                          clientHandshake.sessionKey, clientHandshake.sessionIV);
        /* 
         * Launch the fowarder 
         */
        forwardThread.start();
    ...
    public static void main(String[] args)
    {
        ...
        /*Verify CA and client certificate*/
		try {
			X509Certificate clientCertificate = VerifyCertificate.readCertificate(arguments.get("usercert"));
